...
if ($missingDirs.Count -gt 0 -or $missingFiles.Count -gt 0) {
    ...
    Write-Host "  All 9 skills and key files present. Project is self-contained." -ForegroundColor Green
}
...
if ($missingSkillMd.Count -gt 0) {
    ...
    Write-Host "  All 9 SKILL.md files present." -ForegroundColor Green
}
