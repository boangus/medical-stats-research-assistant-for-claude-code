...
- **检查方法**：
  1. 核对 `src/shared/value-normalization/` 处理结果：TCM 术语映射到 GB/T 16751 标准、数值变体（如"1.0" vs "1"）已统一、单位已转换。
...
- **检查方法**：
  1. 运行 PHI 检测脚本 `src/shared/data_sharing/deidentification.py`，扫描 18 类 HIPAA PHI 标识符。
