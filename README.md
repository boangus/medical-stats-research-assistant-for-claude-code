...
│   ├── medical-paper/            # 📄 医学论文参考（agents/references/templates）
│   └── medical-pipeline/         # 📑 医学写作流水线参考（agents/references/templates）
│
├── scripts/                      # 辅助脚本
