## [MSRA-FUSION] Upstream Provenance

- **Source**: `academic-research-skills` v3.12.1 lineage ([Unreleased] post-#256)
- **Upstream commit**: `88fc003` (Imbad0202/academic-research-skills)
- **Merged**: 2026-06-18
- **Sync guide**: To update from upstream, diff `shared/` from the new upstream commit against these files. ARS skills' `shared/` references do not require path rewriting.
