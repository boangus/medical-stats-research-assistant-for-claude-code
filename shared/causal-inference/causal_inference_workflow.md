...
- **R 模板**: `shared/templates/dag_variable_selection_template.R`
- **Python DAG**: `shared/templates/variable_dag_template.py`（变量构造依赖 DAG）
- **Python 因果**: `shared/causal-inference/causal_inference_dowhy.py`（DoWhy 因果推断）
