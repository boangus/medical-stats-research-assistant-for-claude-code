...
```r
# 来源: shared/reproducibility/reproducibility_check.R
# 用法: 传入分析脚本路径，自动执行 3 次并生成复现报告

source("shared/reproducibility/reproducibility_check.R")
...
```python
# 来源: shared/reproducibility/reproducibility_check.py
...
```python
# 来源: shared/reproducibility/pipeline_auditor.py
