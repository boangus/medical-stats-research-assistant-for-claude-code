...
- **检查方法**：
  ...
  3. 运行 `shared/reporting-guidelines/statcheck_patterns.py` 自动校验。
...
|---------|---------|---------------|---------|----------|
| RCT（两臂/多臂） | CONSORT 2010 | `shared/reporting-guidelines/CONSORT_checklist.md` | [{是/否}] | [{符合/不符合/N/A}] |
| RCT（非劣效） | CONSORT + 非劣效扩展 | `shared/reporting-guidelines/CONSORT_checklist.md` | [{是/否}] | [{符合/不符合/N/A}] |
| 观察性（队列/病例对照/横断面） | STROBE | `shared/reporting-guidelines/STROBE_checklist.md` | [{是/否}] | [{符合/不符合/N/A}] |
| 诊断研究 | STARD 2015 | `shared/reporting-guidelines/STARD_checklist.md` | [{是/否}] | [{符合/不符合/N/A}] |
| 系统综述/Meta 分析 | PRISMA 2020 | `shared/reporting-guidelines/PRISMA_2020_checklist.md` | [{是/否}] | [{符合/不符合/N/A}] |
| 网状 Meta 分析 | PRISMA-NMA | `shared/reporting-guidelines/PRISMA_NMA_checklist.md` | [{是/否}] | [{符合/不符合/N/A}] |
| 预测模型（AI/ML） | TRIPOD+AI | `shared/reporting-guidelines/TRIPOD_AI_checklist.md` | [{是/否}] | [{符合/不符合/N/A}] |
| 预后研究 | REMARK | `shared/reporting-guidelines/REMARK_checklist.md` | [{是/否}] | [{符合/不符合/N/A}] |
| 卫生经济学 | CHEERS | `shared/reporting-guidelines/CHEERS_checklist.md` | [{是/否}] | [{符合/不符合/N/A}] |
| 真实世界研究 | RECORD（STROBE 扩展） | `shared/reporting-guidelines/STROBE_checklist.md` | [{是/否}] | [{符合/不符合/N/A}] |
...
- §3 APA 7th 效应量报告矩阵
- `shared/reporting-guidelines/` 下对应的报告规范文件
...
- 项目内参考：`shared/reporting-guidelines/`、`shared/reproducibility/reproducibility_guide.md`
