...
- **检查方法**：
  1. 核对方法选择与 `shared/statistics-methods/stat_test_decision_tree.md` 一致。
...
- **检查方法**：
  ...
  2. 引用 `shared/templates/` 中的代码模板是否明确。
  3. 分析步骤是否可转化为可执行脚本。
...
- 项目内参考：`shared/sap/sap_standard.md`、`shared/statistics-methods/INDEX.md`
