...
> 门闸检查清单详见 `skills/data-prep/SKILL.md` Phase 7 及 `shared/templates/quality-gates/data_quality_gate_report.md`。
...
### 与其他文档的关系
- **上游**：`shared/sap/sap_standard.md` — SAP 定义变量角色，驱动验证规则
- **下游**：`shared/templates/data-prep/cleaning_log_template.md` — 验证发现的问题驱动清洗
- **下游**：`shared/templates/quality-gates/data_quality_gate_report.md` — Stage 1.5 门闸消费验证结果
- **关联**：`shared/templates/data-prep/eda_report_template.md` — EDA 报告补充验证发现
- **关联**：`shared/templates/variable_spec_template.md` — 变量字典定义类型和格式依据
