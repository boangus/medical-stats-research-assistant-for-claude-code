...
def make_bland_altman_plot(x1, x2, xlabel=None, ylabel='Difference',
    ...
    ax.text(0.05, 0.95,
            ...
            f'95% LOA: {lower_limit:.3f} to {upper_limit:.3f}\n'
            f'r = {r:.3f} ({format_p_value(p_val)})',
...
"@
Set-Content -Path "d:\开发\medical-stats-research-assistant\shared\templates\extended_figure_templates.py" -Value $content -Encoding UTF8
Write-Host "Created extended_figure_templates.py"
