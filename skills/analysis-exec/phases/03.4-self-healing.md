...
> **错误诊断参考**: src/shared/error-diagnostics/error_patterns.md — 常见错误模式与诊断流程
> **自动修复参考**: src/shared/error-diagnostics/auto_fix_suggestions.py (Python) / .r (R) — 自动修复建议
...
> 完整可执行代码（Firth Logistic / VIF 诊断 / Cox PH 违反处理，含 R 和 Python 双语言）见 [`src/shared/error-diagnostics/code_fixes_reference.md`](../../src/shared/error-diagnostics/code_fixes_reference.md)。
> 简要诊断规则见 [`src/shared/error-diagnostics/error_patterns.md`](../../src/shared/error-diagnostics/error_patterns.md)（S1-S4 / D1-D3 / E1-E3 / C1-C3）。
