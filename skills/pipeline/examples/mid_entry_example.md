...
```
Entering Stage 3 (REVIEW) -- using medical-paper-reviewer quick mode
...
Loading medical-paper-reviewer SKILL.md (full mode)...
...
output_formatter executing LaTeX conversion...
