...
peer-review/references/review_criteria_framework.md plus overall.
Scores are on the 0-100 scale per
peer-review/references/quality_rubrics.md 鈥?the scale the
delta thresholds below and the v3.2 Early-Stopping Criterion
("delta < 3 points on the 0-100 rubric", medical-pipeline/SKILL.md) assume.
```
