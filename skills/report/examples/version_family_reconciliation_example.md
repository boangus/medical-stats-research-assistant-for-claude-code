...
This example shows how MSRA surfaces a citation-version mismatch without auto-correcting the manuscript.
...
## Acceptable Fix A 鈥?Cite the Preprint Explicitly
...
## Acceptable Fix B 鈥?Use the Proceedings Record
...
## Acceptable Fix C 鈥?Compare Versions Explicitly
...
The important rule is that each version-bound claim has its own slug and locator. MSRA does not decide which version is "better"; the scholar selects the version appropriate to the claim.
