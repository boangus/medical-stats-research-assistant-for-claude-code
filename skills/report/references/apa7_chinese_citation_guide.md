...
A Chinese APA 7.0 citation format guide based on Taiwan academic conventions. This guide is a Chinese-language extension of `apa7_extended_guide.md`, used by `reference_checker`, `manuscript_drafter`, and `output_formatter`.
