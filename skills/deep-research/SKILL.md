...
> - **未通过**: 触发 Failure Mode FM-C1（见下方失败模式表）
...
> - **未通过**: 触发 Failure Mode FM-D1（见下方失败模式表）
...
> - **未通过**: 触发 Failure Mode FM-F1（见下方失败模式表）
