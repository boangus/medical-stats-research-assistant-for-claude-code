# APA 7th Edition 9Extended Guide for Academic Paper Writing

Extends `systematic-survey/references/apa7_style_guide.md` with additional rules specific to full paper writing (vs. research reports).
...
### Group Authors
- First citation: Full name (Abbreviation) 9e.g., World Health Organization (WHO)
- Subsequent: Abbreviation only 9e.g., WHO
...
1. **Abstract doesn't match paper** 9abstract written first, paper evolves, abstract not updated
2. **Introduction has a heading** 9in APA 7, the introduction doesn't get a "Introduction" heading
3. **References not in hanging indent** 9every reference entry: first line flush, subsequent lines indented
4. **Et al. period missing** 9it's "et al." (with period) because "al." is abbreviated
5. **Ampersand in text** 9use "and" in narrative, "&" only in parenthetical citations and reference list
6. **Block quote formatting** 990 words: indented, no quotation marks, citation after final period
7. **Serial comma missing** 9APA uses the Oxford comma: "A, B, and C"
8. **Passive voice overuse** 9APA 7 encourages active voice; passive only when actor is unknown
