...
**Agent**: `paper_outline_agent`
**Output**: Paper Outline + Evidence Map

- Structure pattern selection (from medical_paper_structure_patterns.md)
...
**Agent**: `bilingual_abstract_agent`
...
- Max 2 revision loops -> back to Phase 4 [manuscript_drafter] (limited to 1 round in medical-pipeline)
