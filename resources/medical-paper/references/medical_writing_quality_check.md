...
Reference this checklist during the self-review step of drafting (manuscript_drafter Step 2.7, report_compiler_agent final check).
...
Apply rules **while writing each section** in the self-review sub-step (Step 2.7 in manuscript_drafter). This catches issues before they propagate.

### During Final Review (Fallback)
If not applied during drafting, run a full-paper sweep before handoff to reference_checker.
