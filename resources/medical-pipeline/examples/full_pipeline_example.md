...
```
Entering Stage 1 (RESEARCH) -- using systematic-survey socratic mode

Loading systematic-survey SKILL.md...
Launching writing_mentor...
```
...
```
Entering Stage 2 (WRITE) -- using medical-paper plan mode

Loading medical-paper SKILL.md...
handoff materials: RQ Brief + Bibliography + Synthesis
paper_config_agent auto-detected systematic-survey output, skipping redundant Phase 0 questions
Launching writing_mentor (plan mode)...
```
...
medical-paper manuscript_drafter writing based on Chapter Plan...
reference_checker verifying citations...
bilingual_abstract_agent writing bilingual abstract...
```
...
```
Entering Stage 3 (REVIEW) -- using medical-paper-reviewer full mode

Loading medical-paper-reviewer SKILL.md...
...
I'll pass the Revision Roadmap to medical-paper revision mode,
...
```
Entering Stage 4 (REVISE) -- using medical-paper revision mode

Loading medical-paper SKILL.md (revision mode)...
Passing Paper Draft + Revision Roadmap...
mock_reviewer monitoring revision quality...
```
...
```
Entering Stage 5 (FINALIZE) -- using medical-paper format-convert mode

Loading medical-paper SKILL.md (format-convert mode)...
Simultaneously handling 2 minor revision items...
output_formatter executing format conversion...
```
...
- Revise again --> just say "revise the paper" (triggers medical-paper revision mode)
