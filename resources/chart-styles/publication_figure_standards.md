...
>
> 关联文件：
> - resources/chart-styles/font_and_size_specs.json — 期刊字体与尺寸规格
> - resources/chart-styles/journal_color_schemes.json — 期刊配色方案
> - resources/chart-styles/chart_types.json — 图表类型规范
> - resources/chart-styles/variable_naming_conventions.md — 变量命名规范
> - src/shared/templates/publication_figure_template.py — 发表级图表 Python 模板
...
与 `resources/chart-styles/journal_color_schemes.json` 集成：
...
与 `resources/chart-styles/font_and_size_specs.json` 集成：
...
> 详细规范参见 `resources/chart-styles/variable_naming_conventions.md`。
> 此处仅列出图表中的关键规则。
