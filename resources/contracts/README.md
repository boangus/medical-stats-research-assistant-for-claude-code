...
Schema: `resources/shared/sprint_contract.schema.json` (Schema 13).
Validator: `scripts/check_sprint_contract.py`.
Spec: `docs/design/2026-04-23-MSRA-v3.6.2-sprint-contract-design.md`.
Protocol: `peer-review/references/sprint_contract_protocol.md`.
...
1. Add the file under `resources/contracts/<domain>/<mode>.json`.
2. Run `python scripts/check_sprint_contract.py <path> --MSRA-version vX.Y.Z`; expect
...
- `passport/audit_artifact_entry.schema.json` (v3.6.7 Step 6) 鈥?`audit_artifact[]` entries
  ...
  `docs/design/2026-04-30-MSRA-v3.6.7-step-6-orchestrator-hooks-spec.md` 搂3.1-搂3.2.
- `passport/version_records.schema.json` (Kong #258) 鈥?optional
...
Spec: `docs/design/2026-04-30-MSRA-v3.6.7-step-6-orchestrator-hooks-spec.md` 搂3.
