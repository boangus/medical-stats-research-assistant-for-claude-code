...
applies_to:
  ...
  - resources/shared/compliance_checkpoint_protocol.md
...
| 工具 | 路径 | 集成方式 |
|------|------|---------|
| SAP 标准 | `src/shared/sap/sap_standard.md` | SAP 条目编号规范 |
| SAP 一致性检查 | `src/shared/sap/sap_consistency_check.py` | 自动验证代码-SAP 映射 |
