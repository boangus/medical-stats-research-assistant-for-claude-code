...
| 工具 | 用途 |
|------|------|
| `src/shared/causal-inference/psm_template.py` | PSM 匹配 + 平衡诊断 |
| `src/shared/causal-inference/overlapping_weighting_template.py` | OW/IPTW 加权 |
| `src/shared/templates/ps_diagnostics_template.R` | R 版 PS 诊断（Love plot + 重叠图） |
