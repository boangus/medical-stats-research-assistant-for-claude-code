...
| 来源 | 内容 | 定位 |
|------|------|------|
| `resources/statistics-methods/chapters/` (56章) | 方法学深度指南 | **权威参考**（深入学习） |
| `skills/stat-method-selector/decision-tree.json` (112方法) | 方法选择决策树 | **规范选择源**（选哪个方法） |
| `resources/statistics-methods/method_selector_mapping.md` | 方法→实现映射 | **实现指引**（怎么写代码） |
...
<!-- 引用深度指南 -->
详见 `resources/statistics-methods/chapters/ch14-mixed-models-for-repeated-measures.md`

<!-- 引用实现映射 -->
代码实现见 `resources/statistics-methods/method_selector_mapping.md` §一 连续结局—参数方法
```
...
# 深度指南: resources/statistics-methods/chapters/ch33-covariate-adjustment.md
```
