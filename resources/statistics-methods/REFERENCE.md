...
| | 因果推断 | MR/中介分析/DID；观察性研究因果推断需谨慎 | [ch45](chapters/ch45-mendelian-randomization.md), [ch30](chapters/ch30-mediation-analysis.md), [ch24](chapters/ch24-difference-in-differences.md) |
...
| [ch45](chapters/ch45-mendelian-randomization.md) | 孟德尔随机化 | 工具变量、因果推断 |
...
- 对于具体代码实现，请参考 `MSRA src/shared/templates/`
