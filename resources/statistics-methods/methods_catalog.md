...
>
> **统计方法指南** :
> - **完整索引**: `resources/statistics-methods/INDEX.md` — 55 章完整索引
> - **速查**: `resources/statistics-methods/cheatsheet.md`
> - **术语表**: `resources/statistics-methods/glossary.md`
...
> ⭐ 本目录的方法学依据可参考 `resources/statistics-methods/` 中的 55 章《统计与方法指南》。
> 以下列出每个方法分类对应的章节，便于深入查阅原始方法学出处。

| 方法分类 | 对应章节 | 关键参考文献 |
|---------|---------------|------------|
| 描述性统计 | ch32（边际效应） | 参见 `resources/statistics-methods/chapters/ch32-marginal-effects.md` |
| 组间比较（t 检验/ANOVA） | ch33（协变量调整） | `resources/statistics-methods/chapters/ch33-covariate-adjustment.md` |
...
| 研究设计（RCT/非劣效性） | **ch01**（非劣效性）**ch04**（整群随机）**ch05**（阶梯楔形） | `resources/statistics-methods/INDEX.md` 第一节 |
